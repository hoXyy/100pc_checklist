...
(Unofficial) V1.59 Updates:
Removed autoupdater due to the URL associated with it being used for malware purposes
(2021-09-24) Critical recompile to get everything working again, no code changes
...
V1.56 Updates:
Added The Simpsons: Hit & Run support (by zoton2).

V1.55 Updates:
The Taxi Driver counter for GTA III will now correctly show it's done when it is completed using skips.

V1.54 Updates:
Fixed the Freight missions for GTA San Andreas

V1.53 Updates:
Fixed the Top Fun missions for the Japanese No-CD version of GTA Vice City
