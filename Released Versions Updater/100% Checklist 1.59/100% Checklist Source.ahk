...
if Memory(3, 0x009F3C17, 4) = 0x6AEC8B55 ; Game is Japanese version
	MemoryValue := Memory(3, 0x0090436C, 4)
MemoryValue /= 1.54
return
...
if Memory(3, 0x009F3C17, 4) = 0x6AEC8B55 ; Game is Japanese version
	MemoryValue := Memory(3, 0x00900A48, 4)
...
; All of the work for this game was done by zoton2 so bug him if something is wrong.
...
; In the below sections, the addresses are all dummies, all of the work is done in custom code below these sections.
; I had to do it this way because everything needs pointers and that's the only way right now.
...
; We read it all here for 100% anyway and reuse it in relevant sections later.
HARPercentAddress1CustomCode:
L1CollectorCards := Memory(3, Memory(5, 0x6C8984, -0x1D8), 1)
L1Wasps := Memory(3, Memory(5, 0x6C8984, 0x238), 1)
L1Gags := Memory(3, Memory(5, 0x6C8984, 0x24C), 1)
L1CharacterClothing := Memory(3, Memory(5, 0x6C8984, 0x234), 1)
L1Vehicles := Memory(3, Memory(5, 0x6C8984, 0x230), 1)
L1TimeTrial := Memory(3, Memory(5, 0x6C8984, 0x19C), 1)
L1CircuitRace := Memory(3, Memory(5, 0x6C8984, 0x1BC), 1)
L1CheckpointRace := Memory(3, Memory(5, 0x6C8984, 0x1DC), 1)
L1M1 := Memory(3, Memory(5, 0x6C8984, 0xBC), 1)
L1M2 := Memory(3, Memory(5, 0x6C8984, 0xDC), 1)
L1M3 := Memory(3, Memory(5, 0x6C8984, 0xFC), 1)
L1M4 := Memory(3, Memory(5, 0x6C8984, 0x11C), 1)
L1M5 := Memory(3, Memory(5, 0x6C8984, 0x13C), 1)
L1M6 := Memory(3, Memory(5, 0x6C8984, 0x15C), 1)
L1M7 := Memory(3, Memory(5, 0x6C8984, 0x17C), 1)
L1BM := Memory(3, Memory(5, 0x6C8984, 0x1FC), 1)
L2CollectorCards := Memory(3, Memory(5, 0x6C8984, -0x1B8), 1)
L2Wasps := Memory(3, Memory(5, 0x6C8984, 0x4A4), 1)
L2Gags := Memory(3, Memory(5, 0x6C8984, 0x4B8), 1)
L2CharacterClothing := Memory(3, Memory(5, 0x6C8984, 0x4A0), 1)
L2Vehicles := Memory(3, Memory(5, 0x6C8984, 0x49C), 1)
L2TimeTrial := Memory(3, Memory(5, 0x6C8984, 0x408), 1)
L2CircuitRace := Memory(3, Memory(5, 0x6C8984, 0x428), 1)
L2CheckpointRace := Memory(3, Memory(5, 0x6C8984, 0x448), 1)
L2M1 := Memory(3, Memory(5, 0x6C8984, 0x308), 1)
L2M2 := Memory(3, Memory(5, 0x6C8984, 0x328), 1)
L2M3 := Memory(3, Memory(5, 0x6C8984, 0x348), 1)
L2M4 := Memory(3, Memory(5, 0x6C8984, 0x368), 1)
L2M5 := Memory(3, Memory(5, 0x6C8984, 0x388), 1)
L2M6 := Memory(3, Memory(5, 0x6C8984, 0x3A8), 1)
L2M7 := Memory(3, Memory(5, 0x6C8984, 0x3C8), 1)
L2BM := Memory(3, Memory(5, 0x6C8984, 0x468), 1)
L3CollectorCards := Memory(3, Memory(5, 0x6C8984, -0x198), 1)
L3Wasps := Memory(3, Memory(5, 0x6C8984, 0x710), 1)
L3Gags := Memory(3, Memory(5, 0x6C8984, 0x724), 1)
L3CharacterClothing := Memory(3, Memory(5, 0x6C8984, 0x70C), 1)
L3Vehicles := Memory(3, Memory(5, 0x6C8984, 0x708), 1)
L3TimeTrial := Memory(3, Memory(5, 0x6C8984, 0x674), 1)
L3CircuitRace := Memory(3, Memory(5, 0x6C8984, 0x694), 1)
L3CheckpointRace := Memory(3, Memory(5, 0x6C8984, 0x6B4), 1)
L3M1 := Memory(3, Memory(5, 0x6C8984, 0x574), 1)
L3M2 := Memory(3, Memory(5, 0x6C8984, 0x594), 1)
L3M3 := Memory(3, Memory(5, 0x6C8984, 0x5B4), 1)
L3M4 := Memory(3, Memory(5, 0x6C8984, 0x5D4), 1)
L3M5 := Memory(3, Memory(5, 0x6C8984, 0x5F4), 1)
L3M6 := Memory(3, Memory(5, 0x6C8984, 0x614), 1)
L3M7 := Memory(3, Memory(5, 0x6C8984, 0x634), 1)
L3BM := Memory(3, Memory(5, 0x6C8984, 0x6D4), 1)
L4CollectorCards := Memory(3, Memory(5, 0x6C8984, -0x178), 1)
L4Wasps := Memory(3, Memory(5, 0x6C8984, 0x97C), 1)
L4Gags := Memory(3, Memory(5, 0x6C8984, 0x990), 1)
L4CharacterClothing := Memory(3, Memory(5, 0x6C8984, 0x978), 1)
L4Vehicles := Memory(3, Memory(5, 0x6C8984, 0x974), 1)
L4TimeTrial := Memory(3, Memory(5, 0x6C8984, 0x8E0), 1)
L4CircuitRace := Memory(3, Memory(5, 0x6C8984, 0x900), 1)
L4CheckpointRace := Memory(3, Memory(5, 0x6C8984, 0x920), 1)
L4M1 := Memory(3, Memory(5, 0x6C8984, 0x7E0), 1)
L4M2 := Memory(3, Memory(5, 0x6C8984, 0x800), 1)
L4M3 := Memory(3, Memory(5, 0x6C8984, 0x820), 1)
L4M4 := Memory(3, Memory(5, 0x6C8984, 0x840), 1)
L4M5 := Memory(3, Memory(5, 0x6C8984, 0x860), 1)
L4M6 := Memory(3, Memory(5, 0x6C8984, 0x880), 1)
L4M7 := Memory(3, Memory(5, 0x6C8984, 0x8A0), 1)
L4BM := Memory(3, Memory(5, 0x6C8984, 0x940), 1)
L5CollectorCards := Memory(3, Memory(5, 0x6C8984, -0x158), 1)
L5Wasps := Memory(3, Memory(5, 0x6C8984, 0xBE8), 1)
L5Gags := Memory(3, Memory(5, 0x6C8984, 0xBFC), 1)
L5CharacterClothing := Memory(3, Memory(5, 0x6C8984, 0xBE4), 1)
L5Vehicles := Memory(3, Memory(5, 0x6C8984, 0xBE0), 1)
L5TimeTrial := Memory(3, Memory(5, 0x6C8984, 0xB4C), 1)
L5CircuitRace := Memory(3, Memory(5, 0x6C8984, 0xB6C), 1)
L5CheckpointRace := Memory(3, Memory(5, 0x6C8984, 0xB8C), 1)
L5M1 := Memory(3, Memory(5, 0x6C8984, 0xA4C), 1)
L5M2 := Memory(3, Memory(5, 0x6C8984, 0xA6C), 1)
L5M3 := Memory(3, Memory(5, 0x6C8984, 0xA8C), 1)
L5M4 := Memory(3, Memory(5, 0x6C8984, 0xAAC), 1)
L5M5 := Memory(3, Memory(5, 0x6C8984, 0xACC), 1)
L5M6 := Memory(3, Memory(5, 0x6C8984, 0xAEC), 1)
L5M7 := Memory(3, Memory(5, 0x6C8984, 0xB0C), 1)
L5BM := Memory(3, Memory(5, 0x6C8984, 0xBAC), 1)
L6CollectorCards := Memory(3, Memory(5, 0x6C8984, -0x138), 1)
L6Wasps := Memory(3, Memory(5, 0x6C8984, 0xE54), 1)
L6Gags := Memory(3, Memory(5, 0x6C8984, 0xE68), 1)
L6CharacterClothing := Memory(3, Memory(5, 0x6C8984, 0xE50), 1)
L6Vehicles := Memory(3, Memory(5, 0x6C8984, 0xE4C), 1)
L6TimeTrial := Memory(3, Memory(5, 0x6C8984, 0xDB8), 1)
L6CircuitRace := Memory(3, Memory(5, 0x6C8984, 0xDD8), 1)
L6CheckpointRace := Memory(3, Memory(5, 0x6C8984, 0xDF8), 1)
L6M1 := Memory(3, Memory(5, 0x6C8984, 0xCB8), 1)
L6M2 := Memory(3, Memory(5, 0x6C8984, 0xCD8), 1)
L6M3 := Memory(3, Memory(5, 0x6C8984, 0xCF8), 1)
L6M4 := Memory(3, Memory(5, 0x6C8984, 0xD18), 1)
L6M5 := Memory(3, Memory(5, 0x6C8984, 0xD38), 1)
L6M6 := Memory(3, Memory(5, 0x6C8984, 0xD58), 1)
L6M7 := Memory(3, Memory(5, 0x6C8984, 0xD78), 1)
L6BM := Memory(3, Memory(5, 0x6C8984, 0xE18), 1)
L7CollectorCards := Memory(3, Memory(5, 0x6C8984, -0x118), 1)
L7Wasps := Memory(3, Memory(5, 0x6C8984, 0x10C0), 1)
L7Gags := Memory(3, Memory(5, 0x6C8984, 0x10D4), 1)
L7CharacterClothing := Memory(3, Memory(5, 0x6C8984, 0x10BC), 1)
L7Vehicles := Memory(3, Memory(5, 0x6C8984, 0x10B8), 1)
L7TimeTrial := Memory(3, Memory(5, 0x6C8984, 0x1024), 1)
L7CircuitRace := Memory(3, Memory(5, 0x6C8984, 0x1044), 1)
L7CheckpointRace := Memory(3, Memory(5, 0x6C8984, 0x1064), 1)
L7M1 := Memory(3, Memory(5, 0x6C8984, 0xF24), 1)
L7M2 := Memory(3, Memory(5, 0x6C8984, 0xF44), 1)
L7M3 := Memory(3, Memory(5, 0x6C8984, 0xF64), 1)
L7M4 := Memory(3, Memory(5, 0x6C8984, 0xF84), 1)
L7M5 := Memory(3, Memory(5, 0x6C8984, 0xFA4), 1)
L7M6 := Memory(3, Memory(5, 0x6C8984, 0xFC4), 1)
L7M7 := Memory(3, Memory(5, 0x6C8984, 0xFE4), 1)
L7BM := Memory(3, Memory(5, 0x6C8984, 0x1084), 1)
BonusMovie := Memory(3, Memory(5, 0x6C8984, 0x704), 1)

; Set the format of floats to actually get accurate calculations (why does AHK work this way?).
SetFormat, Float, 0.20

; Works out percentages for most of the stuff in the game.
...
; Vehicles need to be handled a bit differently because we also need to add ones from bonus missions and races.
...
; Add everything up to get the full percentage.
MemoryValue := WaspsPercentage + CollectorCardsPercentage + CharacterClothingPercentage + BMPercentage + GagsPercentage + VehiclesPercentage + StoryMissionsPercentage + StreetRacesPercentage + BonusMovie

; Set the format of floats back to what it was before.
SetFormat, Float, 0.%DecimalPlaces%
return
